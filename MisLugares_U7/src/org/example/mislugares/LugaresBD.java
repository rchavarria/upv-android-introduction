...
public class LugaresBD extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase bd) {
		bd.execSQL("CREATE TABLE lugares ("
				...
				+ "direccion TEXT, " + "longitud REAL,  " + "latitud REAL,  "
				+ "tipo INTEGER, " + "foto TEXT, " + "telefono INTEGER, "
				+ "url TEXT, " + "comentario TEXT, " + "fecha LONG, "
				+ "valoracion REAL)");
		...
		bd.execSQL("INSERT INTO lugares VALUES (null, 'La Vital', "
				...
				+ "'El típico centro comercial', " + System.currentTimeMillis()
				+ ", 2.0)");
	}
